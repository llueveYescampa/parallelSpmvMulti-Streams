...
void getRowsNnzPerProc(int *rowsPP, const int *global_n, const int *global_nnz, const int *row_Ptr, const int nStreams);
             ...
             )
{
    ...
    getRowsNnzPerProc((rowsPP+1),n_global,nnz_global, *rowPtr, nStreams);
